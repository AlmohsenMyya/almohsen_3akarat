...
/// Section Widget
PreferredSizeWidget _buildAppBar() { return CustomAppBar(title: Padding(padding: EdgeInsets.only(left: 24.h), child: RichText(text: TextSpan(children: [TextSpan(text: "lbl_create_a".tr, style: CustomTextStyles.headlineSmallff16161a), TextSpan(text: "lbl_vertex_account".tr, style: CustomTextStyles.headlineSmallff1786f9)]), textAlign: TextAlign.left))); } 
/// Section Widget
